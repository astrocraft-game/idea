...
This layer handles the largest-scale decisions in the game:
...
Star gates are discovered and first constructed at this epoch. They are the game's most transformative logistics technology.

Star gates allow:

- direct travel from S2 to any planet, orbit, or star system
- bypassing the station-in-orbit requirement for planet access
- compressing interstellar distances into managed corridors
- creating focal points of traffic that are worth defending

Star gates should not erase logistics. They should reconfigure it. Gates introduce:
...
- vast
- consequential
- graph-like but grounded in physical reality

The player should feel that every star system is a real place with real industry, not an icon on a strategy map.

## Key decisions

- which star system is worth the investment of an interstellar journey
- where to place star gates for maximum strategic value
- which stations to send on long one-way trips
- how to defend the gate network
...
1. identify a distant star system worth reaching
2. send a station on a long journey
3. establish an initial orbit and begin developing the system
4. connect it to the gate network when ready

### Gate network loop

1. choose where to build the next gate pair
2. invest the enormous capital and material cost
3. manage the new corridor's traffic and defense
4. absorb the strategic benefit while maintaining the infrastructure
...
## Flux material and atomic shrinking
