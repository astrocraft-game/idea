...
The element scope is the final inversion of the game's structure.
...
- from orbit to stars and galaxies
...
This is not a new game. It is the same game translated into radically different physical scales.
...
The element scope should not replace the other scopes. It should consume them.

Planetary industry, orbital production, space expansion, and route planning all remain necessary because the player still needs:
...
The element scope becomes the missing inner half of the endgame. Macro stabilization holds the line; elemental stabilization makes lasting repair possible.
