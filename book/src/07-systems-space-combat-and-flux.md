...
- **Precursor guardians**
  Fixed defenses protecting ruins and valuable technologies.
- **Flux phenomena**
  Environmental events that disrupt logistics, computation, or structural reliability.
- **Rogue minds**
  Late-game industrial rivals born from dangerous choices or systemic corruption.
